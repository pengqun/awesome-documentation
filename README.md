...
- [Awesome Code Docs](https://github.com/johnxie/awesome-code-docs) - Deep-dive tutorials that explain architecture and implementation patterns in open-source projects.
