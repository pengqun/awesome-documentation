...
- [Pushpen](https://github.com/David19876543210/pushpen-action) ![GitHub Repo stars](https://img.shields.io/github/stars/David19876543210/pushpen-action) - Watches a GitHub repository and generates README, changelog, API reference, and onboarding guide updates from the actual diff on every push, delivered as a pull request. Also available as a GitHub Action for CI-driven generation.
